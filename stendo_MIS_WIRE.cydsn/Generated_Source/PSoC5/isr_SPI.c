...
void isr_SPI_SetVector(cyisraddress address)
{
    ...
    ramVectorTable[CYINT_IRQ_BASE + (uint32)isr_SPI__INTC_NUMBER] = address;
}
...
cyisraddress isr_SPI_GetVector(void)
{
    ...
    return ramVectorTable[CYINT_IRQ_BASE + (uint32)isr_SPI__INTC_NUMBER];
}
...
*
*   Note calling isr_SPI_Start or isr_SPI_StartEx will 
*   override any effect this API would have had. This API should only be called
*   after isr_SPI_Start or isr_SPI_StartEx has been called. 
