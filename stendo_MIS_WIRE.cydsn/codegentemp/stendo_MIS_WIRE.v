// ======================================================================
// stendo_MIS_WIRE.v generated from TopDesign.cysch
// 12/14/2017 at 16:15
...
module top ;
    ...
    defparam PulseCounter_1.CompareMode = 1;
    ...
    always @(posedge clk)
    begin
        cy_srff_3 <= (Net_1693 | PulseCounterEN_1) & ~Net_2603;
    end
    ...
    begin : demux_1
        ...
        assign Net_1693 = tmp__demux_1_0_reg;
        assign Net_1695 = tmp__demux_1_1_reg;
    end
    // -- De Mux end --
	...
	cy_psoc3_pins_v1_10
		#(.id("d1c83af6-8b78-4059-bf8e-e91a9ece4bcd"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    CyControlReg_v1_80 SPIM_CS (
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam SPIM_CS.Bit0Mode = 0;
    defparam SPIM_CS.Bit1Mode = 0;
    defparam SPIM_CS.Bit2Mode = 0;
    defparam SPIM_CS.Bit3Mode = 0;
    defparam SPIM_CS.Bit4Mode = 0;
    defparam SPIM_CS.Bit5Mode = 0;
    defparam SPIM_CS.Bit6Mode = 0;
    defparam SPIM_CS.Bit7Mode = 0;
    defparam SPIM_CS.BitValue = 1;
    defparam SPIM_CS.BusDisplay = 0;
    defparam SPIM_CS.ExtrReset = 0;
    defparam SPIM_CS.NumOutputs = 1;
    ...
    defparam PulseCounter_2.CompareMode = 1;
    ...
    defparam PulseCounter_3.CompareMode = 1;
    ...
    defparam PulseCounter_4.CompareMode = 1;
