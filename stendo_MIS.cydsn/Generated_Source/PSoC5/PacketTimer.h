...
#define Timestamp_Resolution                 24u
...
#define Timestamp_INIT_PERIOD             16777215u
...
***************************************/
    ...
    ***************************************/
    ...
    #define Timestamp_CONTROL             (* (reg8 *) Timestamp_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__CONTROL_REG )
        ...
        #define Timestamp_CAPTURE_LSB         (* (reg8 *) Timestamp_TimerUDB_sT24_timerdp_u0__F0_REG )
        #define Timestamp_CAPTURE_LSB_PTR       ((reg8 *) Timestamp_TimerUDB_sT24_timerdp_u0__F0_REG )
        #define Timestamp_PERIOD_LSB          (* (reg8 *) Timestamp_TimerUDB_sT24_timerdp_u0__D0_REG )
        #define Timestamp_PERIOD_LSB_PTR        ((reg8 *) Timestamp_TimerUDB_sT24_timerdp_u0__D0_REG )
        #define Timestamp_COUNTER_LSB         (* (reg8 *) Timestamp_TimerUDB_sT24_timerdp_u0__A0_REG )
        #define Timestamp_COUNTER_LSB_PTR       ((reg8 *) Timestamp_TimerUDB_sT24_timerdp_u0__A0_REG )
    #elif(Timestamp_Resolution <= 16u) /* 8-bit Timer */
        #if(CY_PSOC3) /* 8-bit addres space */
            #define Timestamp_CAPTURE_LSB         (* (reg16 *) Timestamp_TimerUDB_sT24_timerdp_u0__F0_REG )
            #define Timestamp_CAPTURE_LSB_PTR       ((reg16 *) Timestamp_TimerUDB_sT24_timerdp_u0__F0_REG )
            #define Timestamp_PERIOD_LSB          (* (reg16 *) Timestamp_TimerUDB_sT24_timerdp_u0__D0_REG )
            #define Timestamp_PERIOD_LSB_PTR        ((reg16 *) Timestamp_TimerUDB_sT24_timerdp_u0__D0_REG )
            #define Timestamp_COUNTER_LSB         (* (reg16 *) Timestamp_TimerUDB_sT24_timerdp_u0__A0_REG )
            #define Timestamp_COUNTER_LSB_PTR       ((reg16 *) Timestamp_TimerUDB_sT24_timerdp_u0__A0_REG )
        #else /* 16-bit address space */
            #define Timestamp_CAPTURE_LSB         (* (reg16 *) Timestamp_TimerUDB_sT24_timerdp_u0__16BIT_F0_REG )
            #define Timestamp_CAPTURE_LSB_PTR       ((reg16 *) Timestamp_TimerUDB_sT24_timerdp_u0__16BIT_F0_REG )
            #define Timestamp_PERIOD_LSB          (* (reg16 *) Timestamp_TimerUDB_sT24_timerdp_u0__16BIT_D0_REG )
            #define Timestamp_PERIOD_LSB_PTR        ((reg16 *) Timestamp_TimerUDB_sT24_timerdp_u0__16BIT_D0_REG )
            #define Timestamp_COUNTER_LSB         (* (reg16 *) Timestamp_TimerUDB_sT24_timerdp_u0__16BIT_A0_REG )
            #define Timestamp_COUNTER_LSB_PTR       ((reg16 *) Timestamp_TimerUDB_sT24_timerdp_u0__16BIT_A0_REG )
        #endif /* CY_PSOC3 */
    #elif(Timestamp_Resolution <= 24u)/* 24-bit Timer */
        #define Timestamp_CAPTURE_LSB         (* (reg32 *) Timestamp_TimerUDB_sT24_timerdp_u0__F0_REG )
        #define Timestamp_CAPTURE_LSB_PTR       ((reg32 *) Timestamp_TimerUDB_sT24_timerdp_u0__F0_REG )
        #define Timestamp_PERIOD_LSB          (* (reg32 *) Timestamp_TimerUDB_sT24_timerdp_u0__D0_REG )
        #define Timestamp_PERIOD_LSB_PTR        ((reg32 *) Timestamp_TimerUDB_sT24_timerdp_u0__D0_REG )
        #define Timestamp_COUNTER_LSB         (* (reg32 *) Timestamp_TimerUDB_sT24_timerdp_u0__A0_REG )
        #define Timestamp_COUNTER_LSB_PTR       ((reg32 *) Timestamp_TimerUDB_sT24_timerdp_u0__A0_REG )
    #else /* 32-bit Timer */
            ...
            #define Timestamp_CAPTURE_LSB         (* (reg32 *) Timestamp_TimerUDB_sT24_timerdp_u0__32BIT_F0_REG )
            #define Timestamp_CAPTURE_LSB_PTR       ((reg32 *) Timestamp_TimerUDB_sT24_timerdp_u0__32BIT_F0_REG )
            #define Timestamp_PERIOD_LSB          (* (reg32 *) Timestamp_TimerUDB_sT24_timerdp_u0__32BIT_D0_REG )
            #define Timestamp_PERIOD_LSB_PTR        ((reg32 *) Timestamp_TimerUDB_sT24_timerdp_u0__32BIT_D0_REG )
            #define Timestamp_COUNTER_LSB         (* (reg32 *) Timestamp_TimerUDB_sT24_timerdp_u0__32BIT_A0_REG )
            #define Timestamp_COUNTER_LSB_PTR       ((reg32 *) Timestamp_TimerUDB_sT24_timerdp_u0__32BIT_A0_REG )
        #endif /* CY_PSOC3 || CY_PSOC5 */ 
    #endif

    #define Timestamp_COUNTER_LSB_PTR_8BIT       ((reg8 *) Timestamp_TimerUDB_sT24_timerdp_u0__A0_REG )
