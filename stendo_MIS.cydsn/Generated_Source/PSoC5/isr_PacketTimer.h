/*******************************************************************************
* File Name: isr_timestampTimer.h
* Version 1.70
*
*  Description:
...
/* Address of the INTC.VECT[x] register that contains the Address of the isr_timestampTimer ISR. */
#define isr_Timestamp_INTC_VECTOR            ((reg32 *) isr_Timestamp__INTC_VECT)

/* Address of the isr_timestampTimer ISR priority. */
#define isr_Timestamp_INTC_PRIOR             ((reg8 *) isr_Timestamp__INTC_PRIOR_REG)

/* Priority of the isr_timestampTimer interrupt. */
#define isr_Timestamp_INTC_PRIOR_NUMBER      isr_Timestamp__INTC_PRIOR_NUM

/* Address of the INTC.SET_EN[x] byte to bit enable isr_timestampTimer interrupt. */
#define isr_Timestamp_INTC_SET_EN            ((reg32 *) isr_Timestamp__INTC_SET_EN_REG)

/* Address of the INTC.CLR_EN[x] register to bit clear the isr_timestampTimer interrupt. */
#define isr_Timestamp_INTC_CLR_EN            ((reg32 *) isr_Timestamp__INTC_CLR_EN_REG)

/* Address of the INTC.SET_PD[x] register to set the isr_timestampTimer interrupt state to pending. */
#define isr_Timestamp_INTC_SET_PD            ((reg32 *) isr_Timestamp__INTC_SET_PD_REG)

/* Address of the INTC.CLR_PD[x] register to clear the isr_timestampTimer interrupt. */
