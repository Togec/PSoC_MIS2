...
*
* \funcusage
*  \snippet SPI1_CS_SUT.c usage_SPI1_CS_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet SPI1_CS_SUT.c usage_SPI1_CS_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet SPI1_CS_SUT.c usage_SPI1_CS_Read  
*******************************************************************************/
...
* preferred SPI1_CS_Read() API because the 
* SPI1_CS_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet SPI1_CS_SUT.c usage_SPI1_CS_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: SPI1_CS_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use SPI1_CS_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - SPI1_CS_0_INTR       (First pin in the list)
    *  - SPI1_CS_1_INTR       (Second pin in the list)
    *  - ...
    *  - SPI1_CS_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet SPI1_CS_SUT.c usage_SPI1_CS_SetInterruptMode
    *******************************************************************************/
    void SPI1_CS_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & SPI1_CS_0_INTR) != 0u) 
		{ 
			 SPI1_CS_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet SPI1_CS_SUT.c usage_SPI1_CS_ClearInterrupt
    *******************************************************************************/
