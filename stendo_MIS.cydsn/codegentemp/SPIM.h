...
#define SPIM_TX_BUFFER_SIZE             (32u)
#define SPIM_RX_BUFFER_SIZE             (32u)
#define SPIM_INTERNAL_TX_INT_ENABLED    (1u)
#define SPIM_INTERNAL_RX_INT_ENABLED    (1u)
...
#define SPIM_INT_ON_RX_NOT_EMPTY    ((uint8) (1u << \
...
#define SPIM_CONTROL_REG            (* (reg8 *) \
                                      SPIM_BSPIM_BidirMode_CtrlReg__CONTROL_REG)
